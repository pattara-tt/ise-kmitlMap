// ────────────────────────────────────────────────────────────────
// Mock in-memory store สำหรับ KMITL MAP (UC1–UC29)
...
function seed() {
  return {
    ...
    // ── คำร้อง (UC11, UC13, UC14, UC15) ───────────────────────
    requests: [
      { id: "RQ-1001", userId: "U007", userName: "กิตติพัฒน์ ใจงาม", type: "ขอแก้ไขข้อมูลห้อง", detail: "ห้อง 106 เปลี่ยนเป็นห้องปฏิบัติการคอมพิวเตอร์", status: "pending", createdAt: "2026-08-18", note: "" },
      { id: "RQ-1002", userId: "U007", userName: "กิตติพัฒน์ ใจงาม", type: "ขอเพิ่มสถานที่", detail: "เพิ่มจุดจอดจักรยานหน้าตึกพระจอมเกล้าฯ", status: "approved", createdAt: "2026-08-10", note: "ส่งต่อผู้ดูแลข้อมูลสถานที่แล้ว" },
      { id: "RQ-1003", userId: "U008", userName: "สมชาย ตั้งมั่น", type: "ขอสิทธิ์เข้าถึงข้อมูล", detail: "ขอสิทธิ์แก้ไขข้อมูลชั้นอาคาร", status: "rejected", createdAt: "2026-08-05", note: "ไม่อยู่ในขอบเขตหน้าที่" },
      { id: "RQ-1004", userId: "U007", userName: "กิตติพัฒน์ ใจงาม", type: "แจ้งข้อมูลผิด", detail: "ชื่ออาจารย์ประจำห้อง 107 ไม่ตรงกับความเป็นจริง", status: "pending", createdAt: "2026-08-21", note: "" },
    ],
    ...
    // ── ข่าวสาร/กิจกรรม + หมวดหมู่ (UC17–UC20, UC29, UC26) ─────
    categories: [
      { id: "CAT-01", name: "วิชาการ", kind: "event", color: "#1A73E8" },
      { id: "CAT-02", name: "กีฬา/นันทนาการ", kind: "event", color: "#188038" },
      { id: "CAT-03", name: "อาคารเรียน", kind: "place", color: "#E37400" },
      { id: "CAT-04", name: "โรงอาหาร", kind: "place", color: "#D93025" },
    ],
    news: [
      { id: "NW-01", title: "ISE Open House 2026", body: "เปิดบ้านคณะวิศวกรรมศาสตร์นานาชาติ พบกิจกรรมและ workshop ตลอดวัน", categoryId: "CAT-01", date: "2026-09-05", status: "published", author: "ณัฐริกา สุขเกษม" },
      { id: "NW-02", title: "กีฬาสีภาควิชา", body: "แข่งขันกีฬาสีประจำปี ณ สนามกีฬากลาง", categoryId: "CAT-02", date: "2026-09-18", status: "draft", author: "ณัฐริกา สุขเกษม" },
    ],
    eventLocations: [
      { id: "EL-01", newsId: "NW-01", label: "ลานหน้าอาคารพระจอมเกล้าฯ (Sc8)", lat: 13.729721, lon: 100.780099, searchable: true },
      { id: "EL-02", newsId: "NW-02", label: "สนามกีฬากลาง สจล.", lat: 13.7275, lon: 100.7772, searchable: true },
    ],
    eventInterest: [
      { id: "EI-01", newsId: "NW-01", userId: "U007", createdAt: "2026-08-20" },
    ],
    eventStats: [
      { newsId: "NW-01", views: 1284, interested: 176, searched: 402 },
      { newsId: "NW-02", views: 356, interested: 41, searched: 88 },
    ],
    ...
    rooms: [
      { id: "RM-01", building: "Sc8", floor: "1", code: "106", name: "ห้อง 106", type: "ห้องเรียน", capacity: 45, teacher: "อ.ดร. ปรีชา วงศ์ทอง", nodeId: "Sc8StudyRoom1F1" },
      { id: "RM-02", building: "Sc8", floor: "1", code: "107", name: "ห้อง 107", type: "ห้องปฏิบัติการ", capacity: 40, teacher: "อ.ดร. สุนิสา ภูผา", nodeId: "Sc8StudyRoom2F1" },
      { id: "RM-03", building: "Sc8", floor: "1", code: "KDAI", name: "Coworking Space KDAI", type: "พื้นที่ทำงานร่วม", capacity: 60, teacher: "-", nodeId: "Sc8StudyRoom3F1" },
    ],
...
// บันทึก log ทุกครั้งที่มีการแก้ไขข้อมูลแผนที่ (ให้ผู้บริหารตรวจสอบใน UC3)
export function logMapEdit({ actorName, actorId, action, target, before = "-", after = "-" }) {
