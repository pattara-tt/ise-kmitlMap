...
- ส่วนที่ไม่อยู่ในขอบเขต SciMap ถูกลบออกแล้ว ได้แก่ ระบบเดินกลางคืน/ไฟส่องสว่าง (streetlight, จุดมืด), การคำนวณร่มเงา/แดด, ข้อมูลน้ำท่วมและ Traffy Fondue, กล้อง CCTV, โหมดนำทาง 3D และแชทบอท AI
