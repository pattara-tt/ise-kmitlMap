...
function EventsPage({ user }) {
  ...
  return (
    <div className="bdi-page">
      <div className="bdi-page-inner">
      <UCHead code="UC26" title="เพิ่มกิจกรรมที่สนใจเข้าร่วม" desc="กดสนใจเพื่อบันทึกกิจกรรมไว้ในรายการของคุณ — สถิติจะถูกส่งให้ฝ่ายประชาสัมพันธ์" />
...
// ── UC25 ส่งข้อเสนอแนะหรือแจ้งปัญหาการใช้ระบบ (เดี๋ยวมาแก้ มันต้องไปแก้ของทางผู้บอด้วย แต่ทำตรงอื่นก่อน) ───────────
