...
function Rooms({ user }) {
  ...
  return (
    <>
      <UCHead code="UC21" title="จัดการรายละเอียดข้อมูลห้องต่างๆ บนตึก บนแผนที่" desc="ข้อมูลห้องนี้จะถูกใช้ในการค้นหาห้องเรียน/ชื่ออาจารย์ของผู้ใช้งานทั่วไป (UC23) และผูกกับหมุดบนผังชั้น" />
...
function Floors({ user }) {
  ...
  return (
    <>
      <UCHead code="UC22" title="จัดการรายละเอียดข้อมูลชั้นต่างๆ บนตึก บนแผนที่" desc="กำหนดชั้นของอาคารและไฟล์ผังชั้นที่จะถูกซ้อนทับบนแผนที่เมื่อผู้ใช้ซูมเข้าอาคาร" />
